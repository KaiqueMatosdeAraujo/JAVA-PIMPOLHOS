  ...
  <form action="ServletPimpolhos" method="post">
		<c:choose>
			...
			<div class="container mt-5 col-6" style="outline: 1px solid #d5d5d5; border-radius: 11px; padding: 16px;">
				<label style="margin-right: 17px;">Nome Categoria:</label><input type="text" name="name" required/><br>
			...
			<div class="container mt-5 col-6" style="outline: 1px solid #d5d5d5; border-radius: 11px; padding: 16px;">
				...
				<label>Nome Categoria:</label><input type="text" name="name" value="${categoria.nome_categoria}" required/><br>
